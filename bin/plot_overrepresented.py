"""plot_overrepresented.py

Plot the number of over-represented blockgroups versus the number of households.
"""
...
with open('extr/units/numbers/numbers.csv', 'r') as source:
    reader =  csv.reader(source, delimiter='\t')
    cats = reader.next()[1:]
    for rows in reader:
